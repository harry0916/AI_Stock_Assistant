package com.nus.stock.gatrader.algorithm;
...
import com.nus.stock.gatrader.biz.Genome;
import com.nus.stock.gatrader.biz.Trader;
import com.nus.stock.gatrader.dt.Node;
...
public class Algorithms {
    ...
    public static List<Genome> select(List<Genome> population, int size, int generation) {
        ...
        List<Genome> replacePool = new ArrayList<Genome>();
        ...
        double progress = ((double) generation / (double) Trader.GENERATIONS);
...
//            mutation_probability = random.nextDouble();//todo
